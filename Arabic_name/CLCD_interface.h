...
/**
 * @brief Enum defining LCD Address Counter (AC) modes.
 */
typedef enum {
	_LCD_AC_CGRAM = 0x40, /**< Address Counter for Character Generator RAM (CGRAM) */
	_LCD_AC_DDRAM = 0x80  /**< Address Counter for Display Data RAM (DDRAM) */
} LCD_AC_Mode_t;
